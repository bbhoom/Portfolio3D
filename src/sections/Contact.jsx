    ...
    return (
        <section className='c-space my-20' id='contact'>
            ...
            <div className='grid lg:grid-cols-2 grid-cols-1 mt-10 gap-5 w-full'>
                ...
                <div className={`flex flex-col gap-5 relative sm:p-10 py-5 px-5 rounded-lg ${!isDarkTheme ? 'bg-gradient-to-b from-[#faedcd] to-[#f9dcc4] text-black' : ''}`}>
                    ...
                    <span id="loading-message" className={`msg text-center block mt-4 ${!isDarkTheme ? 'text-black' : 'text-white'}`} style={{ display: 'none' }}>
                        Please wait, it's loading...
                    </span>
                    <span id="sent-message" className={`msg text-center block mt-4 ${!isDarkTheme ? 'text-black' : 'text-white'}`} style={{ display: 'none' }}>
